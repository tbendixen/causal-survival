...
-   Inverse probability of treatment weighting in Cox proportional hazards model **\[DONE - needs bootstrapping\]**
-   Inverse probability of treatment weighting in Kaplan-Meier **\[DONE\]**
-   Sub-group analysis with g-computation and logistic polynomial regression **\[DONE - needs bootstrapping\]**
-   Sub-group analysis with IP weighted Kaplan-Meier **\[DONE\]**
...
Let's compare our g-computation results with IP weighted Kaplan-Meier. Now, for subgroup analysis with IPTW, there are a few subtleties. Hernan and Robins (2020:165-166) writes:
