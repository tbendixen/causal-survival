...
p_unw <- ggplot() + 
  ...
  annotate(geom = "label", x = 0.8, y = 20, label = "Treated (actual)", 
           fill = isfahan[2], color = "white", hjust = 1) +
  annotate(geom = "label", x = 0.8, y = -50, label = "Untreated (actual)", 
...
p_w <- ggplot() + 
  ...
  annotate(geom = "label", x = 0.8, y = 20, label = "Treated (actual)", 
           fill = isfahan[2], color = "white", hjust = 1) +
  annotate(geom = "label", x = 1, y = 30, label = "Treated (IPTW pseudo-population)", 
           fill = colorspace::lighten(isfahan[2], 0.35), color = "white", hjust = 1) +
  annotate(geom = "label", x = 0.8, y = -50, label = "Untreated (actual)", 
           fill = isfahan[6], color = "white", hjust = 1) +
  annotate(geom = "label", x = 1, y = -70, label = "Untreated (IPTW pseudo-population)", 
